  ...
  return (
    <Modal
      ...
      <Form form={form} initialValues={record} labelCol={{span: 6}} wrapperCol={{span: 14}}>
        ...
        <Form.Item name="k8s_config" tooltip="Kubernetes集群配置文件内容" label="Kubeconfig" extra="如果此环境启用 Kubernetes 发布，请粘贴集群的 kubeconfig 凭证。强烈建议在本地将其转换为 Base64 编码文本（cat ~/.kube/config | base64 -w 0）后再粘贴至此，以防止屏幕明文泄露。">
